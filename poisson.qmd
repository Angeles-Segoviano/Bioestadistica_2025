...
for (n in tamaños) {
  ...
  #Estadísticas
  cat("\n n =", n, "\n'")
  cat("Media de Z:", mean(z), "(teórico: 0)\n")
  cat("Varianza de Z:", var(z), "(teórico: 1)\n")
}
...
qqnorm(z_30, main = "Q-Q Plot para n = 30")
qqline(z_30, col = "red", lwd = 2)


par(mfrow = c(1, 2))

x_pois <- 0:20
plot(x_pois, dpois(x_pois, lambda), type = "h", lwd = 3,
